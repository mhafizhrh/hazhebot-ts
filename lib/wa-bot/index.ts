...
import { Client, List, Location, Buttons, GroupChat } from "whatsapp-web.js";
...
client.on("message", async (msg) => {
    console.log("mentions", msg.mentionedIds);

    console.log("MESSAGE RECEIVED:", msg.body);
    let cmd = "";
    if (msg.body.startsWith(botPrefix)) {
        cmd = msg.body.substring(1).split(" ")[0];
    }

    fs.readdirSync("./lib/wa-bot/commands").forEach(async (file) => {
